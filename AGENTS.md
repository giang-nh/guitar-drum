...
**PWA ưu tiên iPad cho việc tập guitar: hiển thị lời+hợp âm, transpose tone, chỉnh BPM, chạy drummer 4/4 theo section với intensity/fill đồng bộ từng dòng, có POC microphone follow lực đàn + tempo + beat-1/bar phase + next-section intent để tự đổi Intensity, glide BPM, sync ô nhịp và arm fill/transition bảo thủ, và hỗ trợ quy trình nhập bài hát từ ảnh/OneNote qua agent — không cần backend ở giai đoạn hiện tại.**
